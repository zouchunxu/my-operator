...
import (
	...
	internalinterfaces "zouchunxu/my-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1 "zouchunxu/my-operator/pkg/client/listers/samplecrd/v1"
