...
import (
	...
	samplecrdv1 "zouchunxu/my-operator/pkg/apis/samplecrd/v1"
	clientset "zouchunxu/my-operator/pkg/client/clientset/versioned"
	networkscheme "zouchunxu/my-operator/pkg/client/clientset/versioned/scheme"
	informers "zouchunxu/my-operator/pkg/client/informers/externalversions/samplecrd/v1"
	listers "zouchunxu/my-operator/pkg/client/listers/samplecrd/v1"
)
